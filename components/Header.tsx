      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        <div className="h-16 flex items-center justify-between">
          <a
            ...
            aria-label="Home"
          >
            <div className="relative w-8 h-8 rounded-md bg-amber-500 flex items-center justify-center shadow-[0_0_24px_-6px_rgba(245,158,11,0.9)] group-hover:shadow-[0_0_28px_-4px_rgba(245,158,11,1)] transition-shadow">
              <span className="font-mono font-bold text-[13px] text-stone-950">sk</span>
            </div>
